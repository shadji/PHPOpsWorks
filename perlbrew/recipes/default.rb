...
perlbrew_cpanm 'Modern Perl modules' do
    modules ['DBI', 'Text::CSV', 'JSON', 'Canary::Stability', 'JSON::XS', 'LWP', 'Module::Build', 'Mail::IMAPClient', 'XML::LibXML', 'Authen::SASL', 'Net::FTP', 'Net::FTPSSL', 'Web::Scraper', 'Mail::POP3Client', 'MIME::Parser', 'DateTime', 'DateTime::Format::MySQL', 'Math::GMP', 'Net::SSH::Perl', 'Math::Pari', 'Net::SFTP']
